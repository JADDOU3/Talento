        ...
        body: Stack(
          children: [
            ...
            SingleChildScrollView(
              ...
              child: Column(
                children: [
                  // Hero Section - no padding at top
                  _HeroSection(
                    lang: _lang,
            ...
            // Floating Navbar on top - transparent background
            Positioned(
              top: 0,
              left: 0,
              right: 0,
...
class _HeroSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: const EdgeInsets.fromLTRB(24, 80, 24, 40), // Increased top padding to 80
      decoration: BoxDecoration(
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        return Transform.translate(
          ...
          child: Opacity(
            opacity: 0.6 + 0.4 * (1 - delayedValue.abs()),
            child: child,
          ),
        );
      },
