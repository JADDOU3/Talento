// lib/features/cart/widgets/recommended_card.dart
        ...
        child: AnimatedSlide(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: Colors.black.withOpacity(_hover ? 0.1 : 0.05), // ✅ FIXED: withOpacity
              ...
              children: [
                PositionedDirectional(
                  ...
                  child: Icon(
                    ...
                    size: 100,
                    color: Colors.white.withOpacity(0.22), // ✅ FIXED: withOpacity
                  ),
                ),
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: Colors.white.withOpacity(0.55), // ✅ FIXED: withOpacity
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: TextStyle(
                            fontSize: 12.5,
                            height: 1.4,
                            color: AppColors.cartForestGreen.withOpacity(0.75), // ✅ FIXED: withOpacity
                          ),
                        ),
                      ),
                      Align(
