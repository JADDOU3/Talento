  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        const Text(
          'ابدأ الآن',
          style: TextStyle(fontSize: 25, fontWeight: FontWeight.w700, color: Color(0xFF1B1F24)),
        ),
          ...
          child: Row(
            children: [
              Container(
                ...
                child: const Icon(Icons.person_add_rounded, color: Color(0xFF10A896), size: 26),
              ),
              ...
              const Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      'أضف بيانات الطفل',
                      style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: Color(0xFF1B1F24)),
                    ),
                    SizedBox(height: 3),
                    Text(
