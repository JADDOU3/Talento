...
class ConflictResolutionService {
  ...
  Future<List<ConflictResolutionLevelModel>> getLevelsByActivity(
      int activityId,
      ) async {
    ...
    final levels = ConflictResolutionLevelModel.listFromPageResponse(data);

    if (levels.isEmpty) {
      throw Exception('No Conflict Resolution levels were found.');
    }
