...
final  Map<int, CognitiveMazeLevelConfig> cognitiveMazeConfigs = {
  ...
  60: CognitiveMazeLevelConfig(
    levelId: 60,
    startPoint: Offset(0.053, 0.5213),
    endPoints: [
      Offset(0.6764, 0.5226),
      Offset(0.6775, 0.8078),
      Offset(0.683, 0.2684),
    ],
    endPointRadius: 0.04,
    wallRects: [
      Rect.fromLTWH(0.3175, 0.1969, 0.3089, 0.0189),
      Rect.fromLTWH(0.4397, 0.2111, 0.0533, 0.0485),
      Rect.fromLTWH(0.3575, 0.2354, 0.0555, 0.0674),
      Rect.fromLTWH(0.5242, 0.2367, 0.0522, 0.0789),
      Rect.fromLTWH(0.423, 0.2805, 0.0767, 0.0938),
      Rect.fromLTWH(0.523, 0.2772, 0.0067, 0.0175),
      Rect.fromLTWH(0.4975, 0.2799, 0.0322, 0.0357),
      Rect.fromLTWH(0.4064, 0.2819, 0.0366, 0.0182),
      Rect.fromLTWH(0.4242, 0.3749, 0.0255, 0.0877),
      Rect.fromLTWH(0.3042, 0.4356, 0.1388, 0.0283),
      Rect.fromLTWH(0.2542, 0.3965, 0.0688, 0.0634),
      Rect.fromLTWH(0.173, 0.5017, 0.1312, 0.0553),
      Rect.fromLTWH(0.2564, 0.4619, 0.0433, 0.0627),
      Rect.fromLTWH(0.1742, 0.4977, 0.0922, 0.0101),
      Rect.fromLTWH(0.263, 0.555, 0.0656, 0.1112),
      Rect.fromLTWH(0.3264, 0.5557, 0.1222, 0.0566),
      Rect.fromLTWH(0.4386, 0.6062, 0.0844, 0.058),
      Rect.fromLTWH(0.4364, 0.6581, 0.02, 0.0614),
      Rect.fromLTWH(0.3597, 0.6332, 0.0489, 0.114),
      Rect.fromLTWH(0.323, 0.6885, 0.0778, 0.0735),
      Rect.fromLTWH(0.4319, 0.7404, 0.0756, 0.0654),
      Rect.fromLTWH(0.3864, 0.7431, 0.08, 0.0209),
      Rect.fromLTWH(0.3953, 0.7411, 0.0389, 0.0081),
      Rect.fromLTWH(0.3986, 0.735, 0.02, 0.0074),
      Rect.fromLTWH(0.4842, 0.6831, 0.1144, 0.058),
      Rect.fromLTWH(0.4997, 0.7384, 0.0233, 0.0067),
      Rect.fromLTWH(0.4797, 0.735, 0.0278, 0.0142),
      Rect.fromLTWH(0.5419, 0.7633, 0.03, 0.0695),
      Rect.fromLTWH(0.4775, 0.5321, 0.1122, 0.0539),
      Rect.fromLTWH(0.3297, 0.4835, 0.1922, 0.0526),
      Rect.fromLTWH(0.4786, 0.3952, 0.1111, 0.0559),
      Rect.fromLTWH(0.4786, 0.4518, 0.0411, 0.0479),
      Rect.fromLTWH(0.6062, 0.2161, 0.1422, 0.0424),
      Rect.fromLTWH(0.7073, 0.2491, 0.0322, 0.0567),
      Rect.fromLTWH(0.6051, 0.2822, 0.1578, 0.0492),
      Rect.fromLTWH(0.5317, 0.3344, 0.1689, 0.0411),
      Rect.fromLTWH(0.6206, 0.3716, 0.0889, 0.1005),
      Rect.fromLTWH(0.5517, 0.4722, 0.2056, 0.0384),
      Rect.fromLTWH(0.7006, 0.5019, 0.0289, 0.0431),
      Rect.fromLTWH(0.6206, 0.5309, 0.1378, 0.0242),
      Rect.fromLTWH(0.6229, 0.5521, 0.0177, 0.066),
      Rect.fromLTWH(0.5551, 0.606, 0.1233, 0.0573),
      Rect.fromLTWH(0.6295, 0.6589, 0.0345, 0.1025),
      Rect.fromLTWH(0.6017, 0.7628, 0.1612, 0.0344),
      Rect.fromLTWH(0.6984, 0.7817, 0.0222, 0.0594),
      Rect.fromLTWH(0.3984, 0.8249, 0.3611, 0.0216),
      Rect.fromLTWH(0.5584, 0.8161, 0.1667, 0.0115),
      Rect.fromLTWH(0.2629, 0.7844, 0.1377, 0.0465),
      Rect.fromLTWH(0.2195, 0.6885, 0.07, 0.0998),
      Rect.fromLTWH(0.2784, 0.6885, 0.0122, 0.1004),
      Rect.fromLTWH(0.2851, 0.7775, 0.0155, 0.0101),
      Rect.fromLTWH(0.1495, 0.577, 0.0822, 0.1133),
      Rect.fromLTWH(0.0151, 0.5331, 0.1289, 0.0458),
      Rect.fromLTWH(0.0106, 0.4974, 0.0234, 0.0478),
      Rect.fromLTWH(0.0184, 0.492, 0.1256, 0.0188),
      Rect.fromLTWH(0.124, 0.4684, 0.0211, 0.0404),
      Rect.fromLTWH(0.134, 0.3716, 0.0855, 0.1066),
      Rect.fromLTWH(0.194, 0.3696, 0.0277, 0.1072),
      Rect.fromLTWH(0.2106, 0.3622, 0.1611, 0.0142),
      Rect.fromLTWH(0.3562, 0.3243, 0.0355, 0.0891),
      Rect.fromLTWH(0.324, 0.3223, 0.0466, 0.0101),
      Rect.fromLTWH(0.2917, 0.2155, 0.0378, 0.12),
    ],
  ),
};