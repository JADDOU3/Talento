...
final  Map<int, CognitiveMazeLevelConfig> cognitiveMazeConfigs = {
  ...
  59: CognitiveMazeLevelConfig(
    ...
    stars: [
      MazeStar(position: Offset(0.6722, 0.3139), color: Colors.blue),
      MazeStar(position: Offset(0.7656, 0.4028), color: Colors.purple),
      MazeStar(position: Offset(0.4556, 0.7121), color: PalestineFlagColors.black),
      MazeStar(position: Offset(0.7089, 0.7221), color: Colors.yellow),
      MazeStar(position: Offset(0.3522, 0.6865), color: PalestineFlagColors.green),
      MazeStar(position: Offset(0.1578, 0.6421), color: Colors.orange),
      MazeStar(position: Offset(0.4667, 0.424), color: PalestineFlagColors.red),
      MazeStar(position: Offset(0.5067, 0.6146), color: PalestineFlagColors.white),
    ],
    targetColors: PalestineFlagColors.all,
    flagRect: Rect.fromLTWH(0.048, 0.76, 0.30, 0.16),
  ),
  60: CognitiveMazeLevelConfig(
    levelId: 60,
    startPoint: Offset(0.0585, 0.5242),
    endPoints: [
      Offset(0.6774, 0.8139),
      Offset(0.6752, 0.5217),
      Offset(0.6819, 0.2672),
    ],
    endPointRadius: 0.04,
    wallRects: [
      Rect.fromLTWH(0.2907, 0.1727, 0.3789, 0.0425),
      Rect.fromLTWH(0.4452, 0.2058, 0.0511, 0.0506),
      Rect.fromLTWH(0.6096, 0.2092, 0.1278, 0.0505),
      Rect.fromLTWH(0.7052, 0.2516, 0.0511, 0.0526),
      Rect.fromLTWH(0.6074, 0.286, 0.1556, 0.056),
      Rect.fromLTWH(0.5352, 0.3408, 0.1433, 0.0357),
      Rect.fromLTWH(0.6219, 0.3732, 0.06, 0.1139),
      Rect.fromLTWH(0.5585, 0.4764, 0.2322, 0.0358),
      Rect.fromLTWH(0.6974, 0.5027, 0.0411, 0.0499),
      Rect.fromLTWH(0.6219, 0.5378, 0.1166, 0.0795),
      Rect.fromLTWH(0.5585, 0.6108, 0.1211, 0.0519),
      Rect.fromLTWH(0.6274, 0.6595, 0.0933, 0.1078),
      Rect.fromLTWH(0.603, 0.7667, 0.1744, 0.0371),
      Rect.fromLTWH(0.7074, 0.7909, 0.0411, 0.0533),
      Rect.fromLTWH(0.5641, 0.8314, 0.1511, 0.0384),
      Rect.fromLTWH(0.5441, 0.7667, 0.02, 0.0944),
      Rect.fromLTWH(0.4007, 0.8341, 0.22, 0.0384),
      Rect.fromLTWH(0.5363, 0.8301, 0.1711, 0.0094),
      Rect.fromLTWH(0.2719, 0.7957, 0.1222, 0.06),
      Rect.fromLTWH(0.2196, 0.6925, 0.0667, 0.1234),
      Rect.fromLTWH(0.1652, 0.5838, 0.0589, 0.1611),
      Rect.fromLTWH(0.2119, 0.5838, 0.0144, 0.1261),
      Rect.fromLTWH(0.0107, 0.5406, 0.1323, 0.1147),
      Rect.fromLTWH(0.1307, 0.5838, 0.0578, 0.0128),
      Rect.fromLTWH(0.0074, 0.4576, 0.0256, 0.0863),
      Rect.fromLTWH(0.0696, 0.4832, 0.0767, 0.0304),
      Rect.fromLTWH(0.0096, 0.4751, 0.1345, 0.0371),
      Rect.fromLTWH(0.1363, 0.3565, 0.0844, 0.1234),
      Rect.fromLTWH(0.3563, 0.3529, 0.0267, 0.0594),
      Rect.fromLTWH(0.3552, 0.3287, 0.0367, 0.087),
      Rect.fromLTWH(0.2185, 0.3347, 0.1622, 0.0371),
      Rect.fromLTWH(0.2652, 0.3272, 0.0922, 0.0068),
      Rect.fromLTWH(0.2974, 0.1998, 0.0245, 0.1281),
      Rect.fromLTWH(0.2607, 0.4003, 0.06, 0.0674),
      Rect.fromLTWH(0.2941, 0.4421, 0.15, 0.0209),
      Rect.fromLTWH(0.2885, 0.4482, 0.1589, 0.0175),
      Rect.fromLTWH(0.2585, 0.465, 0.0189, 0.0661),
      Rect.fromLTWH(0.2585, 0.4677, 0.0245, 0.0594),
      Rect.fromLTWH(0.2874, 0.4509, 0.0133, 0.1058),
      Rect.fromLTWH(0.1852, 0.5041, 0.0955, 0.0553),
      Rect.fromLTWH(0.2685, 0.567, 0.0545, 0.0991),
      Rect.fromLTWH(0.2585, 0.5542, 0.0345, 0.0128),
      Rect.fromLTWH(0.2852, 0.5515, 0.0155, 0.0094),
      Rect.fromLTWH(0.3041, 0.5609, 0.1422, 0.0499),
      Rect.fromLTWH(0.4363, 0.6095, 0.0856, 0.0526),
      Rect.fromLTWH(0.4352, 0.6499, 0.0211, 0.0708),
      Rect.fromLTWH(0.3607, 0.6344, 0.0378, 0.1052),
      Rect.fromLTWH(0.3252, 0.6944, 0.0733, 0.0735),
      Rect.fromLTWH(0.3519, 0.689, 0.0088, 0.0102),
      Rect.fromLTWH(0.433, 0.747, 0.0722, 0.0607),
      Rect.fromLTWH(0.4352, 0.7996, 0.07, 0.0102),
      Rect.fromLTWH(0.4919, 0.6877, 0.1011, 0.0553),
      Rect.fromLTWH(0.4807, 0.7376, 0.0245, 0.0101),
      Rect.fromLTWH(0.5019, 0.741, 0.0133, 0.0121),
      Rect.fromLTWH(0.3719, 0.747, 0.0655, 0.023),
      Rect.fromLTWH(0.3985, 0.7403, 0.0034, 0.0067),
      Rect.fromLTWH(0.4274, 0.7706, 0.0089, 0.0048),
      Rect.fromLTWH(0.4819, 0.5385, 0.0988, 0.0459),
      Rect.fromLTWH(0.3385, 0.49, 0.1856, 0.0438),
      Rect.fromLTWH(0.4896, 0.3989, 0.0934, 0.0526),
      Rect.fromLTWH(0.4863, 0.401, 0.0344, 0.1004),
      Rect.fromLTWH(0.3574, 0.2409, 0.0511, 0.0627),
      Rect.fromLTWH(0.5341, 0.2382, 0.0378, 0.0776),
      Rect.fromLTWH(0.4096, 0.2841, 0.1356, 0.0202),
      Rect.fromLTWH(0.4296, 0.3036, 0.1134, 0.0122),
      Rect.fromLTWH(0.4263, 0.3144, 0.0711, 0.0607),
      Rect.fromLTWH(0.4274, 0.3745, 0.02, 0.0809),
    ],
  ),
};